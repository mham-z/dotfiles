...
hl.animation({leaf = "border", enabled = false, speed = 3.39, bezier = "easeOutQuint"})
...
hl.animation({leaf = "workspaces", enabled = false, speed = 1.5, bezier = "almostLinear", style = "fade"})
